        ...
        switch (pid = fork()){
            ...
            case 0:  // Proceso Hijo  
                    ...
                    while (1){
                        ...
                        {
                            typeMsg = 21;
                            msgrcv( shm.msqid, (struct msgbuf *)&message, sizeof(type_message)-sizeof(long), (int)typeMsg, 0); 
                            typeMsg = 106;
                            msgrcv( shm.msqid, (struct msgbuf *)&message, sizeof(type_message)-sizeof(long), (int)typeMsg, 0); 
                            while( desp != 24 && desp != 109)
                            {
                                if (desp == 21)
                                {
                                     message.type= 20;
                                ...
                                auxLib = desp;
                                typeMsg = auxLib;
                                msgrcv( shm.msqid, (struct msgbuf *)&message, sizeof(type_message)-sizeof(long), (int)typeMsg, IPC_NOWAIT);
